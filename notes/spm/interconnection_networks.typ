...
#figure(image("images/linear_array_network.png"), caption: [
...
#figure(image("images/mesh_network.png"), caption: [
  Mesh Topology|400
])
...
#figure(image("images/torus_network.png"), caption: [
  Torus Topology|400
])
...
#figure(image("images/binary_tree_network.png"), caption: [
...
#figure(image("images/hypercube_network.png"), caption: [
...
#figure(image("images/fat_tree_network.png"), caption: [
...
#figure(image("images/fat_tree_network2.png"), caption: [
  Fat-Tree Topology|500
])
...
#figure(image("images/dragonfly_network.png"), caption: [
