...
of them in order to minimize the quantization error.
...
#figure(
  image("images/k_means_clusters.png", width: 50%),
...
#strong[hyperspherical] clusters, while for other shapes like #emph[two moons]

#figure(
  image("images/two_moons.png", width: 50%),
  caption: [ Two Moons ],
)
